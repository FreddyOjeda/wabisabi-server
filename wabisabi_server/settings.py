"""
Django settings for wabisabi_server project.
...
SECRET_KEY = 'django-insecure-yqli0uo+obk3sf9s8p_dh+)w!$(*x0)3x376a*q)!#@yvwo@&#'
...
ROOT_URLCONF = 'wabisabi_server.urls'
...
WSGI_APPLICATION = 'wabisabi_server.wsgi.application'
